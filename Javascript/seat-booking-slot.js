...
$(document).ready(function(){
  ...
  function billpayment()
  {
   ...
   req.open("GET","http://showpura.infinityfreeapp.com/pages/payment-successful-page.php?totalpayment="+total_ammount+"&totalseat="+total_seat+"&seatnoplatinum="+seatnop+"&seatnogold="+seatnog+"&seatnosilver="+seatnos,true);
   req.send();
