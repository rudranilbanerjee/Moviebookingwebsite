...
function fetchcities(str)
{
    ...
    else
    {
        ...
        req.open("GET","http://showpura.infinityfreeapp.com/pages/film-cities.php?searchbox="+str,true);
        req.send();
...
function validation(str)
{
  ...
  else
  {
      ...
      req.open("GET","http://showpura.infinityfreeapp.com/pages/city-validation.php?searchbox1="+str,true);
      req.send();
      req.onreadystatechange=function(){
        if(req.readyState==4 && req.status==200){
