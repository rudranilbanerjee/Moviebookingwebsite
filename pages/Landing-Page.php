...
<head>
    ...
    <link rel="stylesheet" href="http://showpura.infinityfreeapp.com/CSS/Home-Page.css">
   ...
   <!--================================ Pop-Up =============================-->
    <div class="pop-up">
        <div class="headSearch">
            <form action="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php" method="GET" 
            id="mysearch">
                <div>
        ...
        <div class="block">
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Delhi">
                    <img class="state" src="../city-icon/delhi-icon.png" >
                    <div>Delhi</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Mumbai">
                    <img class="state" src="../city-icon/mumbai-icon.png" >
                    <div>Mumbai</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Bengaluru">
                    <img class="state" src="../city-icon/bengaluru-icon.png" >
                    <div>Bengaluru</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Kolkata">
                    <img class="state" src="../city-icon/kolkata-icon.jpg" >
                    <div>Kolkata</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Hydrabad">
                    <img class="state" src="../city-icon/hydrabad-icon.png" >
                    <div>Hyderabad</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Chandigarh">
                    <img class="state" src="../city-icon/chandigarh-icon.png" >
                    <div>Chandigarh</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Chennai">
                    <img class="state" src="../city-icon/chennai-icon.png" >
                    <div>Chennai</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Ahmedabad">
                    <img class="state" src="../city-icon/ahmedabad-icon.png" >
                    <div>ahmedabad</div>
                </a>
            </div>
            <div class="stateIcon">
                <a href="http://showpura.infinityfreeapp.com/pages/city-wise-cinema-hall.php?cityname=Kochi">
    ...
    <div class="menu-bar" id="menu">
        <div class="first-content" id="menu1">
            <div class="reflection onAccess">
                ...
                Hey, 
                <span style="color:#FF0080; font-size:18px; ">Rudranil Banerjee<?php echo $_SESSION['username'];?></span>
            </div>    
        ...
        <div style="display:none;" class="notification" id="walletbar">
            ...
            <div class="walletSection">
                <img src="http://showpura.infinityfreeapp.com/movie-poster/wallet-logo.jpg" width="90" height="90">
                <div style="font-size:20px;" id="submenu">Total money</div>
                <div style="display:flex;margin: 10px 0;"><img style="margin-top: 10px;" src="http://showpura.infinityfreeapp.com/movie-poster/Indian-Rupee-symbol.png" width="30" height="30">
                    <div style="font-size:40px;">0.00 Rs</div>
                </div>
                <a href="http://showpura.infinityfreeapp.com/pages/under-construction.php" style="text-decoration:none; color:white;">
        ...
        <div class="navigation-bar"> 
            ...
            <div class="next-content">
                <a href="http://showpura.infinityfreeapp.com/pages/purchase-history.php" style="text-decoration:none;">
        ...
        <div class="signOutSec">   
            <a style="text-decoration: none;" href="http://showpura.infinityfreeapp.com/pages/sign-out.php">
                <div class="sign-out">
                    <span>Sign Out</span>
                </div>
            </a>
    ...
    <div class="menu-bar" id="menu">
        <div class="first-content" id="menu1">
            ...
            <a style="text-decoration: none;" href="http://showpura.infinityfreeapp.com/pages/sign-up-page.php">
                <div class="login-reg">
                   Log in/Register
                </div>
            </a>        
...
<header> 
    ...
    <div class="first-header">
    	<div class="company-logo">
            <img src="http://showpura.infinityfreeapp.com/movie-poster/logo-of-company.jpg" width="250" height="70">
        </div>
    	<div class="searchBox">
      ...
      {?>
        <div>
            <a href="http://showpura.infinityfreeapp.com/pages/log-in-page.php">
...
<nav>
    <div class="second-header">
    	<div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Movies</a></div>
    	<div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Stream</a></div>
    	<div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Event</a></div>
    	<div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Plays</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Sports</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Activities</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Buzz</a></div>
        <div><a class="xyz navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">ListYourShow</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Corporates</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Offers</a></div>
        <div><a class="navi" href="http://showpura.infinityfreeapp.com/pages/under-construction.php">Gift cards</a></div>
    </div>
</nav>
...
<section>
    ...
    <div class="container">
    	<div class="image-container">
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104678">
                    <img style="margin-left:0px;" src="http://showpura.infinityfreeapp.com/movie-poster/slide2.png">
                </a>
            </div>
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104682">
                    <img src="http://showpura.infinityfreeapp.com/movie-poster/slide3.jpg">
                </a>
            </div>
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104346">
                    <img src="http://showpura.infinityfreeapp.com/movie-poster/slide4.jpg">
                </a>
           </div>
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104347">
                    <img src="http://showpura.infinityfreeapp.com/movie-poster/slide5.jpg">
                </a>
           </div>
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104678">
                    <img src="http://showpura.infinityfreeapp.com/movie-poster/slide2.png" >
                </a>
           </div>
    	   <div>
                <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104682">
    ...
    <div class="recommended">
        <div><button class="btn-scroll" id="btnRec-scroll-left" ><i class="fa fa-chevron-left"></i></button></div>
        <div><button class="btn-scroll" id="btnRec-scroll-right"><i class="fa fa-chevron-right"></i></button></div>
        <h1 class="recommendedHeading">Recommended Movies</h1>
        <div class="image-box">
                <li>
                    <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104678">
                        <img src="http://showpura.infinityfreeapp.com/movie-poster/Anek-poster.jpg" >
                        <div class="img-link">ANEK<br>
                            Action/Political/Thriler
                        </div>
                    </a>
                </li>
                <li>
                    <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104346">
                        <img src="http://showpura.infinityfreeapp.com/movie-poster/Avenger-poster.jpg" >
                        <div class="img-link">AVENGER<br>
                            Action/SCI-FI
                        </div>
                    </a>
                </li>
                <li>
                    <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104679">
                        <img src="http://showpura.infinityfreeapp.com/movie-poster/Bhoolbhula2-poster.jpg" >
                        <div class="img-link">BHOOL BHULAIYAA 2
                ...
                <li>
                    <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104682">
                        <img src="http://showpura.infinityfreeapp.com/movie-poster/RRR-poster.jpg" >
                        <div class="img-link">RRR
                            <div>Action/Thriler</div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=104681">
                        <img src="http://showpura.infinityfreeapp.com/movie-poster/Top-gun-poster.jpg" >
                        <div class="img-link">TOP GUN
                            <div>Action/SCI-FI</div>
                        </div>
                    </a>
                </li>
                <li>
...
<script>
    //popup upload automatically when the window was loaded 
    window.onload=setTimeout(function(){
        popUp.style.display="flex";
    },1500)
</script>
<script src="http://showpura.infinityfreeapp.com/Javascript/Home-Page.js"></script>
</body>
</html>