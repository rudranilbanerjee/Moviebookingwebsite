...
<head>
    ...
    <link rel="stylesheet" href="http://showpura.infinityfreeapp.com/CSS/citywise-cinemaHall.css">
    	...
    	<div class="image-box1">
            ...
            <div class="arrangeMovieList">
                ...
                if($_SESSION['num']!=0){
                    ...
                    ?>
                            <div class="valid-movie <?php echo strpos($language['movielanguage'.$k],',') ?>">
                                <a style="text-decoration:none;" href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid='<?php echo $_SESSION['movieid'.$k];?>'">
                                <img class="img-link1" src="http://showpura.infinityfreeapp.com/movie-poster/<?php echo $image['imageid'.$k]; ?>.jpg" width="210" height="350px">
...
<script src="http://showpura.infinityfreeapp.com/Javascript/city-wise-cinema-hall.js"></script>
