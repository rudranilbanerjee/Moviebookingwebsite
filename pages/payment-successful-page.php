...
<body>
<div class="login">
   <form class="log-in-form" action="http://showpura.infinityfreeapp.com/pages/login-for-payment.php" method="post">
   ...
   <div style="font-size:17px;margin-left:110px;">New user? <a href="http://showpura.infinityfreeapp.com/pages/sign-up-page-for-payment.php" style="color:white; font-size:20px;text-decoration:none;">Sign up</a></div>
</div>
</body>
</html>
<?php
...
{
  header('location:http://showpura.infinityfreeapp.com/pages/payment-information-details.php');	
}
?>