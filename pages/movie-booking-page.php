...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://showpura.infinityfreeapp.com/CSS/movie-booking-page.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="http://showpura.infinityfreeapp.com/CSS/datewise-movie-list1.css">
    ...
    <div class="ending">
       ...
       <script>
            function initClock(){
                ...
                req.open("GET","http://showpura.infinityfreeapp.com/pages/datewise-movie-list1.php?day="+week[dname]+"&date="+dnum+"&month="+months[mo]+"&hour="+hou+"&today="+dnum,true);
                req.send();
       ...
       <script src="http://showpura.infinityfreeapp.com/Javascript/movie-booking-page.js"></script>
  </body>
  </html>