...
<link rel="stylesheet" type="text/css" href="http://showpura.infinityfreeapp.com/CSS/sign-up from style.css">
<!-- Add icon library -->
...
<body>
  <div class="container">
  	<div class="counterImg"><img class="image-set" src="http://showpura.infinityfreeapp.com/movie-poster/s6.jpg" width="100%" height="100%"></img></div>
  	<div class="form-container">
  	  <div class="form-img">
        <img src="http://showpura.infinityfreeapp.com/movie-poster/logo-of-company.jpg" width="100" height="40">
      </div>	
      <form action="http://showpura.infinityfreeapp.com/pages/new-user-homepage.php" method="post" class="form-box">
      ...
      <div class="log-in">
        <span >Already a member?</span><a style="color:red;" href="http://showpura.infinityfreeapp.com/pages/log-in-page.php"> LOG IN</a>
      </div>
    <div>
  </div>
  <script src="http://showpura.infinityfreeapp.com/Javascript/sign-up-from.js"></script>
</body>
</html>