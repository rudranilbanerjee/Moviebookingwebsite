...
{
    header('location:http://showpura.infinityfreeapp.com/pages/log-in-page.php');
}
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="http://showpura.infinityfreeapp.com/CSS/purchase-history.css">
</head>
<body>
    <!--================================ Pop-Up =============================-->
    <div class="pop-up">
    ...
    <div class="menu-bar" id="menu">
        ...
        <div style="display:none;" class="notification" id="walletbar">
            ...
            <div class="walletSection">
                ...
                <a href="http://showpura.infinityfreeapp.com/pages/pages/under-construction.php" style="text-decoration:none; color:white;">
