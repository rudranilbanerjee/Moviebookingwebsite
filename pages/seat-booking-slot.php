...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://showpura.infinityfreeapp.com/CSS/seat-booking-slot.css">
...
<div class="first-header">
	<div class="showDetails">
	    <a class="backSign" href="http://showpura.infinityfreeapp.com/pages/movie-booking-page.php?movieid=<?php echo $_SESSION['movie_id'];?>"><i class=" fa fa-chevron-left" style="color:#FF0080;margin-top:10px; font-size:20px;"></i></a>
...
<script src="http://showpura.infinityfreeapp.com/Javascript/seat-booking-slot.js"></script>
