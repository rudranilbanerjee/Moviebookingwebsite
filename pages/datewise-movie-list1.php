        ...
        <div class="hallDetails">
            ...
            <div class="movieTimes">
              <?php 
               ...
               {?>
        	       <a href="http://showpura.infinityfreeapp.com/pages/seat-booking-slot.php?time=<?php echo $time1['firstshow'.$k];?>&cinemahallname=
               ...
               {
               ?>
        	       <a href="http://showpura.infinityfreeapp.com/pages/seat-booking-slot.php?time=<?php echo $time2['secondshow'.$k];?>&cinemahallname=
                   <?php echo $hallname['hall_name'.$k];?>&cinemahallid=<?php echo $cinemahallid['cinemahallid'.$k];?>" 
                   style="text-decoration:none;color:#FF0080;">
               ...
               {
               ?>
        	       <a href="http://showpura.infinityfreeapp.com/pages/seat-booking-slot.php?time=<?php echo $time3['thirdshow'.$k];?>&cinemahallname=
                   <?php echo $hallname['hall_name'.$k];?>&cinemahallid=<?php echo $cinemahallid['cinemahallid'.$k];?>" 
                   style="text-decoration:none;color:#FF0080;">
