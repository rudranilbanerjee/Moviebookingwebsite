...
<head>
  ...
  <meta name="viewport", content="width=device-width,initial-scale=1.0">
	<link rel="stylesheet" type="text/css" href="http://showpura.infinityfreeapp.com/CSS/payment-page.css">
</head>
<body>
      <div class="payment-box">
      	<div class="border">
      		...
      		<div class="client-detail">
      			<form class="log-in-form" action="http://showpura.infinityfreeapp.com/pages/client-booking-information-insert.php" method="GET">
